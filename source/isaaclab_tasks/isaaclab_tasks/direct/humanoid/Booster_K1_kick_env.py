...
#! TESTING CHANGES (JIHWAN) -- TO BE REMOVED LATER
# it directly inherits from DirectRLEnv instead of LocomotionEnv... 
# and now I plan to add changes to make a "target" vector which represents the position and velocity of the ball after kicking
...
from isaaclab.assets import ArticulationCfg, RigidObjectCfg, RigidObject, Articulation
...
class BoosterK1Env(DirectRLEnv):
    cfg: BoosterK1EnvCfg
